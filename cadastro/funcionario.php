    ...
    <div class="form-funcionario border shadow-lg">
        <form method="post" action="../method/cadastro_funcionario.php" class="p-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="cpf" id="cpf" class="form-control border-dark" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="email" id="email" class="form-control border-dark" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Senha</label>
                <input type="password" name="senha" id="senha" class="form-control border-dark mb-2" required>
                <label class="form-label">Confirmar Senha</label>
                <input type="password" name="confirma_senha" id="confirma_senha" class="form-control border-dark" required>
            </div>
